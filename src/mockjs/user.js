...
export default {
  ...
  getUserInfo: config => {
    ...
    if(data.token === "admin") {
      userList = {
        roles: ["admin"],
        name: "admin",
        avatar: "https://wx.qlogo.cn/mmopen/vi_32/un2HbJJc6eiaviaibvMgiasFNlVDlNOb9E6WCpCrsO4wMMhHIbsvTkAbIehLwROVFlu8dLMcg00t3ZtOcgCCdcxlZA/132" // 头像 
      }
   ...
   * @param {(code: number, count: number, data: *[])}
  */
  getUserList: config => {
